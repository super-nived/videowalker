  ...
  return (
    <div className="gift-container">
      <div className="gift-banner">
        ...
        <p className="content">Find your mystery box by following the location below. Tap the location button to view the location, and click the image  above to see the gift</p>
